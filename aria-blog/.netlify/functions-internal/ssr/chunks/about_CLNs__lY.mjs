/* empty css                         */
import { c as createComponent, r as renderTemplate, m as maybeRenderHead, a as addAttribute, b as createAstro, d as renderComponent, F as Fragment } from './astro/server_B2sFbQH5.mjs';
import 'kleur/colors';
import 'clsx';
...
Experience
</h2> <div class="px-5 py-10"> ${experiences.map((experience, loop) => {
    return renderTemplate`${renderComponent($$result2, "Fragment", Fragment, {}, { "default": ($$result3) => renderTemplate`${loop == 0 || loop == 1 ? renderTemplate`<div class="pb-10 border-l border-gray-200 dark:border-neutral-700"> ${renderComponent($$result3, "AboutExperience", $$AboutExperience, { "dates": experience.dates, "role": experience.role, "company": experience.company, "description": experience.description, "logo": experience.logo })} </div>` : renderTemplate`${renderComponent($$result3, "AboutExperience", $$AboutExperience, { "dates": experience.dates, "role": experience.role, "company": experience.company, "description": experience.description, "logo": experience.logo })}`}` })}`;
  })} </div> <h2 class="mt-5 mb-2 text-2xl font-bold lg:mt-10 sm:mt-6 dark:text-neutral-200">Let's Connect</h2> <p class="text-sm leading-6 text-gray-600 dark:text-neutral-400 sm:leading-7 lg:leading-8 sm:text-base lg:text-lg">
...
}, "/Users/rjohnson/Documents/astro/aria-blog/src/pages/about.astro", void 0);

const $$file = "/Users/rjohnson/Documents/astro/aria-blog/src/pages/about.astro";
const $$url = "/about";
